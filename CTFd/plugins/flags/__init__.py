...
class CTFdOnlineFlag(BaseFlag):
 
    name = "online"
    templates = {
        'create': '/plugins/flags/assets/online/create.html',
        'update': '/plugins/flags/assets/online/edit.html',
    }
...
FLAG_CLASSES = {"static": CTFdStaticFlag, "regex": CTFdRegexFlag,"individual": CTFdIndividualFlag,"online":CTFdOnlineFlag}
